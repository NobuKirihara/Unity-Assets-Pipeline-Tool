...
&emsp;● For a easier time try to use the Suffixes and a standard naming order and that the tool can find and link everthing &emsp;for you.<br>
...
&ensp;Extra:<br>
&emsp;Feel free to use and change the script, as i use it and find a way to improve or add new featrues will be keep &emsp;updating it.
