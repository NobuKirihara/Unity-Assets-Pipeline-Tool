...
&emsp;<b>● Backup Originals </b>if enabled move the original image to Assets/Old_Assets/IMG and places optimized versions in the source folder. if &emsp;disabled overwrites the original file with the optimized version.<br><br> 
&ensp;<b>How to use:</b> <br>
